...
#include <UniversalTelegramBot.h>    /* for using Telegram Bot API */
...
String chatId = "1330776504";
String BOTtoken = "5910528018:AAFoAs0KZgaF2WW7kfaJ6egd6vTi-RtI0Cs";
...
void loop(){
    ...
    if(digitalRead(BUTTON) == LOW){  // check Button read 
    digitalWrite(FLASH_LED, HIGH);
    delay(200);
    sendPhotoTelegram(); 
    digitalWrite(FLASH_LED, LOW);
